"use strict";
exports.id = "node_modules_angular_material_fesm2020_autocomplete_mjs-_32bf0";
exports.ids = ["node_modules_angular_material_fesm2020_autocomplete_mjs-_32bf0"];
exports.modules = {
...
/* harmony import */ var _angular_material_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/material/core */ 42721);
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ 15962);
/* harmony import */ var _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/cdk/scrolling */ 99921);
/* harmony import */ var _angular_cdk_overlay__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/cdk/overlay */ 41437);
/* harmony import */ var _angular_cdk_a11y__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/cdk/a11y */ 69543);
/* harmony import */ var _angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/cdk/coercion */ 71347);
/* harmony import */ var _angular_cdk_platform__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/cdk/platform */ 30361);
...
/* harmony import */ var _angular_cdk_portal__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @angular/cdk/portal */ 30859);
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @angular/forms */ 67232);
/* harmony import */ var _angular_material_form_field__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @angular/material/form-field */ 13953);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! rxjs/operators */ 32778);
/* harmony import */ var _angular_cdk_bidi__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @angular/cdk/bidi */ 73867);
...
const _c1 = ["*"];
const panelAnimation = (0,_angular_animations__WEBPACK_IMPORTED_MODULE_8__.trigger)('panelAnimation', [(0,_angular_animations__WEBPACK_IMPORTED_MODULE_8__.state)('void, hidden', (0,_angular_animations__WEBPACK_IMPORTED_MODULE_8__.style)({
  opacity: 0,
  transform: 'scaleY(0.8)'
})), (0,_angular_animations__WEBPACK_IMPORTED_MODULE_8__.transition)(':enter, hidden => visible', [(0,_angular_animations__WEBPACK_IMPORTED_MODULE_8__.group)([(0,_angular_animations__WEBPACK_IMPORTED_MODULE_8__.animate)('0.03s linear', (0,_angular_animations__WEBPACK_IMPORTED_MODULE_8__.style)({
  opacity: 1
})), (0,_angular_animations__WEBPACK_IMPORTED_MODULE_8__.animate)('0.12s cubic-bezier(0, 0, 0.2, 1)', (0,_angular_animations__WEBPACK_IMPORTED_MODULE_8__.style)({
  transform: 'scaleY(1)'
}))])]), (0,_angular_animations__WEBPACK_IMPORTED_MODULE_8__.transition)(':leave, visible => hidden', [(0,_angular_animations__WEBPACK_IMPORTED_MODULE_8__.animate)('0.075s linear', (0,_angular_animations__WEBPACK_IMPORTED_MODULE_8__.style)({
  opacity: 0
}))])]);
...
class _MatAutocompleteBase extends _MatAutocompleteMixinBase {
  ...
  constructor(_changeDetectorRef, _elementRef, _defaults, platform) {
    ...
    this._activeOptionChanges = rxjs__WEBPACK_IMPORTED_MODULE_9__.Subscription.EMPTY;
...
class _MatAutocompleteTriggerBase {
  ...
  constructor(_element, _overlay, _viewContainerRef, _zone, _changeDetectorRef, scrollStrategy, _dir, _formField, _document, _viewportRuler, _defaults) {
    ...
    this.optionSelections = (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.defer)(() => {
      ...
      if (options) {
        return options.changes.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.startWith)(options), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.switchMap)(() => (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.merge)(...options.map(option => option.onSelectionChange))));
      }
      // If there are any subscribers before `ngAfterViewInit`, the `autocomplete` will be undefined.
      // Return a stream that we'll replace with the real one once everything is in place.
      return this._zone.onStable.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.switchMap)(() => this.optionSelections));
    });
  ...
  get panelClosingActions() {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.merge)(this.optionSelections, this.autocomplete._keyManager.tabOut.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.filter)(() => this._overlayAttached)), this._closeKeyEventStream, this._getOutsideClickStream(), this._overlayRef ? this._overlayRef.detachments().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.filter)(() => this._overlayAttached)) : (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.of)()).pipe(
    // Normalize the output so we return a consistent type.
    (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.map)(event => event instanceof _angular_material_core__WEBPACK_IMPORTED_MODULE_1__.MatOptionSelectionChange ? event : null));
  }
  ...
  _getOutsideClickStream() {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.merge)((0,rxjs__WEBPACK_IMPORTED_MODULE_9__.fromEvent)(this._document, 'click'), (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.fromEvent)(this._document, 'auxclick'), (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.fromEvent)(this._document, 'touchend')).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.filter)(event => {
  ...
  _handleKeydown(event) {
    ...
    if (keyCode === _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_10__.ESCAPE && !hasModifier) {
      event.preventDefault();
    }
    if (this.activeOption && keyCode === _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_10__.ENTER && this.panelOpen && !hasModifier) {
      ...
      if (keyCode === _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_10__.TAB || isArrowKey && !hasModifier && this.panelOpen) {
  ...
  _subscribeToClosingActions() {
    ...
    const optionChanges = this.autocomplete.options.changes.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.tap)(() => this._positionStrategy.reapplyLastPosition()),
    // Defer emitting to the stream until the next tick, because changing
    // bindings in here will cause "changed after checked" errors.
    (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.delay)(0));
    // When the zone is stable initially, and when the option list changes...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.merge)(firstStable, optionChanges).pipe(
  ...
  _handleOverlayEvents(overlayRef) {
    ...
    overlayRef.keydownEvents().subscribe(event => {
      ...
      if (event.keyCode === _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_10__.ESCAPE && !(0,_angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_10__.hasModifierKey)(event) || event.keyCode === _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_10__.UP_ARROW && (0,_angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_10__.hasModifierKey)(event, 'altKey')) {
...
;
//# sourceMappingURL=node_modules_angular_material_fesm2020_autocomplete_mjs-_32bf0.js.map