"use strict";
exports.id = "node_modules_angular_router_fesm2020_router_mjs-_6f001";
exports.ids = ["node_modules_angular_router_fesm2020_router_mjs-_6f001"];
exports.modules = {
...
/* harmony export */   DefaultTitleStrategy: function() { return /* binding */ DefaultTitleStrategy; },
...
/* harmony export */   NavigationSkipped: function() { return /* binding */ NavigationSkipped; },
...
/* harmony export */   RouterLinkWithHref: function() { return /* binding */ RouterLink; },
...
/* harmony export */   TitleStrategy: function() { return /* binding */ TitleStrategy; },
...
/* harmony export */   createUrlTreeFromSnapshot: function() { return /* binding */ createUrlTreeFromSnapshot; },
/* harmony export */   defaultUrlMatcher: function() { return /* binding */ defaultUrlMatcher; },
/* harmony export */   provideRouter: function() { return /* binding */ provideRouter; },
/* harmony export */   provideRoutes: function() { return /* binding */ provideRoutes; },
/* harmony export */   withDebugTracing: function() { return /* binding */ withDebugTracing; },
/* harmony export */   withDisabledInitialNavigation: function() { return /* binding */ withDisabledInitialNavigation; },
/* harmony export */   withEnabledBlockingInitialNavigation: function() { return /* binding */ withEnabledBlockingInitialNavigation; },
/* harmony export */   withHashLocation: function() { return /* binding */ withHashLocation; },
/* harmony export */   withInMemoryScrolling: function() { return /* binding */ withInMemoryScrolling; },
/* harmony export */   withNavigationErrorHandler: function() { return /* binding */ withNavigationErrorHandler; },
/* harmony export */   withPreloading: function() { return /* binding */ withPreloading; },
/* harmony export */   withRouterConfig: function() { return /* binding */ withRouterConfig; },
...
/* harmony export */   "ɵafterNextNavigation": function() { return /* binding */ afterNextNavigation; },
/* harmony export */   "ɵflatten": function() { return /* binding */ flatten; },
/* harmony export */   "ɵwithPreloading": function() { return /* binding */ withPreloading; }
/* harmony export */ });
...
/* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/platform-browser */ 95989);
/**
...
class ActivatedRoute {
  ...
  component, futureSnapshot) {
    ...
    this.title = this.data?.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(d => d[RouteTitleKey])) ?? (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)(undefined);
...
function noMatch(segmentGroup) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.throwError)(new NoMatch$1(segmentGroup));
}
function absoluteRedirect(newTree) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.throwError)(new AbsoluteRedirect(newTree));
}
function namedOutletsRedirect(redirectTo) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.throwError)(new _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵRuntimeError"](4000 /* RuntimeErrorCode.NAMED_OUTLET_REDIRECT */, NG_DEV_MODE$7 && `Only absolute redirects can have named outlets. redirectTo: '${redirectTo}'`));
}
function canLoadFails(route) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.throwError)(navigationCancelingError(NG_DEV_MODE$7 && `Cannot load children because the guard of the route "path: '${route.path}'" returned false`, 3 /* NavigationCancellationCode.GuardRejected */));
}
/**
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.from)(routes).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.concatMap)(r => {
      ...
      if (isEmptyError(e)) {
        if (noLeftoversInUrl(segmentGroup, segments, outlet)) {
          return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)(new UrlSegmentGroup([], {}));
        }
  ...
  matchSegmentAgainstRoute(injector, rawSegmentGroup, route, segments, outlet) {
    if (route.path === '**') {
      ...
      if (route.loadChildren) {
        const loaded$ = route._loadedRoutes ? (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)({
      ...
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)(new UrlSegmentGroup(segments, {}));
    }
    return matchWithChecks(rawSegmentGroup, route, segments, injector, this.urlSerializer).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.switchMap)(({
      matched,
      consumedSegments,
      remainingSegments
    }) => {
      ...
      return childConfig$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeMap)(routerConfig => {
        ...
        if (childConfig.length === 0 && slicedSegments.length === 0) {
          return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)(new UrlSegmentGroup(consumedSegments, {}));
        }
...
function applyRedirects(environmentInjector, configLoader, urlSerializer, config) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.switchMap)(t => applyRedirects$1(environmentInjector, configLoader, urlSerializer, t.extractedUrl, config).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(urlAfterRedirects => ({
    ...t,
    urlAfterRedirects
  }))));
}
...
function recognize$1(injector, rootComponentType, config, urlTree, url, urlSerializer, paramsInheritanceStrategy = 'emptyOnly') {
  return new Recognizer(injector, rootComponentType, config, urlTree, url, paramsInheritanceStrategy, urlSerializer).recognize().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.switchMap)(result => {
    if (result === null) {
...
class Recognizer {
  ...
  recognize() {
    ...
    return this.processSegmentGroup(this.injector, this.config, rootSegmentGroup, PRIMARY_OUTLET).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(children => {
      if (children === null) {
        return null;
      }
  ...
  processChildren(injector, config, segmentGroup) {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.from)(Object.keys(segmentGroup.children)).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.concatMap)(childOutlet => {
      const child = segmentGroup.children[childOutlet];
      ...
      return children;
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.takeWhile)(children => children !== null), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.defaultIfEmpty)(null), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.last)(), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(children => {
  ...
  processSegmentAgainstRoute(injector, route, rawSegment, segments, outlet) {
    if (route.redirectTo || !isImmediateMatch(route, rawSegment, segments, outlet)) return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)(null);
    let matchResult;
    if (route.path === '**') {
      ...
      matchResult = (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)({
        snapshot,
        consumedSegments: [],
        remainingSegments: []
      });
    } else {
      matchResult = matchWithChecks(rawSegment, route, segments, injector, this.urlSerializer).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(({
        matched,
        consumedSegments,
        remainingSegments,
        parameters
    ...
    return matchResult.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.switchMap)(result => {
      ...
      return this.processSegment(childInjector, childConfig, segmentGroup, slicedSegments, matchedOnOutlet ? PRIMARY_OUTLET : outlet).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(children => {
        if (children === null) {
          return null;
        }
        return [new TreeNode(snapshot, children)];
...
function recognize(injector, rootComponentType, config, serializer, paramsInheritanceStrategy) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeMap)(t => recognize$1(injector, rootComponentType, config, t.urlAfterRedirects, serializer.serialize(t.urlAfterRedirects), serializer, paramsInheritanceStrategy).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(targetSnapshot => ({
    ...t,
    targetSnapshot
  }))));
}
function resolveData(paramsInheritanceStrategy, injector) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeMap)(t => {
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.from)(canActivateChecks).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.concatMap)(check => runResolve(check.route, targetSnapshot, paramsInheritanceStrategy, injector)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.tap)(() => canActivateChecksResolved++), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.takeLast)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeMap)(_ => canActivateChecksResolved === canActivateChecks.length ? (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)(t) : rxjs__WEBPACK_IMPORTED_MODULE_1__.EMPTY));
  });
}
...
class RouterConfigLoader {
  ...
  loadModuleFactoryOrRoutes(loadChildren) {
    return wrapIntoObservable(loadChildren()).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(maybeUnwrapDefaultExport), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeMap)(t => {
  ...
  setupNavigations(router) {
    ...
    (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.switchMap)(overallTransitionState => {
      ...
      switchTap(t => {
        if (t.guards.canActivateChecks.length) {
          return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)(t).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.tap)(t => {
            ...
            return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)(t).pipe(resolveData(router.paramsInheritanceStrategy, this.environmentInjector), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.tap)({
      ...
      switchTap(t => {
        ...
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.combineLatest)(loadComponents(t.targetSnapshot.root)).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.defaultIfEmpty)(), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.take)(1));
      }), switchTap(() => this.afterPreactivation()), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(t => {
