"use strict";
exports.id = "node_modules_angular_cdk_fesm2020_tree_mjs-_d2801";
exports.ids = ["node_modules_angular_cdk_fesm2020_tree_mjs-_d2801"];
exports.modules = {
...
/* harmony export */ });
/* harmony import */ var _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/cdk/collections */ 48009);
...
class NestedTreeControl extends BaseTreeControl {
  ...
  _getDescendants(descendants, dataNode) {
    ...
    if (Array.isArray(childrenNodes)) {
      ...
      childrenNodes.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.filter)(Boolean)).subscribe(children => {
...
class CdkTree {
  ...
  _observeRenderChanges() {
    ...
    if ((0,_angular_cdk_collections__WEBPACK_IMPORTED_MODULE_0__.isDataSource)(this._dataSource)) {
      ...
      dataStream = (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)(this._dataSource);
    }
    if (dataStream) {
      this._dataSubscription = dataStream.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.takeUntil)(this._onDestroy)).subscribe(data => this.renderNodeChanges(data));
...
CdkTree.ɵcmp = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
  ...
  contentQueries: function CdkTree_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵcontentQuery"](dirIndex, CdkTreeNodeDef, 5);
    }
    if (rf & 2) {
      let _t;
...
CdkTreeNode.ɵdir = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineDirective"]({
  ...
  hostBindings: function CdkTreeNode_HostBindings(rf, ctx) {
    if (rf & 2) {
      _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵattribute"]("aria-expanded", ctx.isExpanded);
    }
  },
  inputs: {
    role: "role"
...
function getParentNodeAriaLevel(nodeElement) {
  ...
  if (!parent) {
    ...
    return (0,_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_4__.coerceNumberProperty)(parent.getAttribute('aria-level'));
  } else {
...
class CdkNestedTreeNode extends CdkTreeNode {
  ...
  ngAfterContentInit() {
    ...
    if (Array.isArray(childrenNodes)) {
      ...
      childrenNodes.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.takeUntil)(this._destroyed)).subscribe(result => this.updateChildrenNodes(result));
    }
    this.nodeOutlet.changes.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.takeUntil)(this._destroyed)).subscribe(() => this.updateChildrenNodes());
  }
...
CdkNestedTreeNode.ɵdir = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineDirective"]({
  ...
  contentQueries: function CdkNestedTreeNode_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵcontentQuery"](dirIndex, CdkTreeNodeOutlet, 5);
    }
    if (rf & 2) {
      let _t;
...
class CdkTreeNodePadding {
  ...
  constructor(_treeNode, _tree, _element, _dir) {
    ...
    this._setPadding();
    if (_dir) {
      _dir.change.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.takeUntil)(this._destroyed)).subscribe(() => this._setPadding(true));
    }
  ...
  _setLevelInput(value) {
    ...
    this._level = (0,_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_4__.coerceNumberProperty)(value, null);
    this._setPadding();
  }
  /**
   * This has been extracted to a util because of TS 4 and VE.
  ...
  _setIndentInput(indent) {
    ...
    this._indent = (0,_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_4__.coerceNumberProperty)(value);
    this._setPadding();
  }
}
...
class CdkTreeNodeToggle {
  ...
  set recursive(value) {
    this._recursive = (0,_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_4__.coerceBooleanProperty)(value);
  }
...
;
//# sourceMappingURL=node_modules_angular_cdk_fesm2020_tree_mjs-_d2801.js.map