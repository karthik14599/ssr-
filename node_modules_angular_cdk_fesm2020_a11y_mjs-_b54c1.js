"use strict";
exports.id = "node_modules_angular_cdk_fesm2020_a11y_mjs-_b54c1";
exports.ids = ["node_modules_angular_cdk_fesm2020_a11y_mjs-_b54c1"];
exports.modules = {
...
/* harmony import */ var _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/cdk/keycodes */ 28437);
...
/* harmony import */ var _angular_cdk_observers__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/cdk/observers */ 87273);
/* harmony import */ var _angular_cdk_layout__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/cdk/layout */ 29247);
...
class ListKeyManager {
  ...
  withTypeAhead(debounceInterval = 200) {
    ...
    this._typeaheadSubscription = this._letterKeyStream.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.tap)(letter => this._pressedLetters.push(letter)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.debounceTime)(debounceInterval), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.filter)(() => this._pressedLetters.length > 0), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(() => this._pressedLetters.join(''))).subscribe(inputString => {
...
class FocusTrap {
  ...
  _executeOnStable(fn) {
    if (this._ngZone.isStable) {
      ...
      this._ngZone.onStable.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.take)(1)).subscribe(fn);
    }
  }
}
/**
...
class InputModalityDetector {
  ...
  constructor(_platform, ngZone, document, options) {
    ...
    this.modalityDetected = this._modality.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.skip)(1));
...
class FocusMonitor {
  ...
  _registerGlobalListeners(elementInfo) {
    ...
    if (++this._monitoredElementCount === 1) {
      ...
      this._inputModalityDetector.modalityDetected.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.takeUntil)(this._stopInputModalityDetector)).subscribe(modality => {
...
;
//# sourceMappingURL=node_modules_angular_cdk_fesm2020_a11y_mjs-_b54c1.js.map