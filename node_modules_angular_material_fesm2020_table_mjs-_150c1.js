"use strict";
exports.id = "node_modules_angular_material_fesm2020_table_mjs-_150c1";
exports.ids = ["node_modules_angular_material_fesm2020_table_mjs-_150c1"];
exports.modules = {
...
/* harmony import */ var _angular_cdk_table__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/cdk/table */ 23165);
...
class _MatTableDataSource extends _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_2__.DataSource {
  ...
  _updateChangeSubscription() {
    ...
    const filteredData = (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.combineLatest)([dataStream, this._filter]).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.map)(([data]) => this._filterData(data)));
    // Watch for filtered data or sort changes to provide an ordered set of data.
    const orderedData = (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.combineLatest)([filteredData, sortChange]).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.map)(([data]) => this._orderData(data)));
    // Watch for ordered data or page changes to provide a paged set of data.
    const paginatedData = (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.combineLatest)([orderedData, pageChange]).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.map)(([data]) => this._pageData(data)));
...
;
//# sourceMappingURL=node_modules_angular_material_fesm2020_table_mjs-_150c1.js.map