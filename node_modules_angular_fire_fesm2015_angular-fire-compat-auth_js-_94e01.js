"use strict";
exports.id = "node_modules_angular_fire_fesm2015_angular-fire-compat-auth_js-_94e01";
exports.ids = ["node_modules_angular_fire_fesm2015_angular-fire-compat-auth_js-_94e01"];
exports.modules = {
...
/* harmony export */   AngularFireAuth: function() { return /* binding */ AngularFireAuth; },
/* harmony export */   AngularFireAuthModule: function() { return /* binding */ AngularFireAuthModule; },
/* harmony export */   LANGUAGE_CODE: function() { return /* binding */ LANGUAGE_CODE; },
/* harmony export */   PERSISTENCE: function() { return /* binding */ PERSISTENCE; },
/* harmony export */   SETTINGS: function() { return /* binding */ SETTINGS; },
/* harmony export */   TENANT_ID: function() { return /* binding */ TENANT_ID; },
/* harmony export */   USE_DEVICE_LANGUAGE: function() { return /* binding */ USE_DEVICE_LANGUAGE; },
/* harmony export */   USE_EMULATOR: function() { return /* binding */ USE_EMULATOR; },
/* harmony export */   "ɵauthFactory": function() { return /* binding */ ɵauthFactory; }
/* harmony export */ });
...
/* harmony import */ var _angular_fire__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/fire */ 72953);
/* harmony import */ var _angular_fire__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_angular_fire__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _angular_fire_compat__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/fire/compat */ 24441);
/* harmony import */ var _angular_fire_compat__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_angular_fire_compat__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony import */ var firebase_compat_app__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! firebase/compat/app */ 78678);
...
const ɵauthFactory = (app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence) => (0,_angular_fire_compat__WEBPACK_IMPORTED_MODULE_4__["ɵcacheInstance"])(`${app.name}.auth`, 'AngularFireAuth', app.name, () => {
...
class AngularFireAuth {
  ...
  tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)(undefined).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.observeOn)(schedulers.outsideAngular), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)(() => zone.runOutsideAngular(() => __webpack_require__.e(/*! import() */ "node_modules_firebase_compat_auth_dist_esm_index_esm_js").then(__webpack_require__.bind(__webpack_require__, /*! firebase/compat/auth */ 26311)))), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(() => (0,_angular_fire_compat__WEBPACK_IMPORTED_MODULE_4__["ɵfirebaseAppFactory"])(options, zone, name)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(app => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.shareReplay)({
      bufferSize: 1,
      refCount: false
    }));
    if ((0,_angular_common__WEBPACK_IMPORTED_MODULE_5__.isPlatformServer)(platformId)) {
      this.authState = this.user = this.idToken = this.idTokenResult = this.credential = (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)(null);
    } else {
      ...
      const _ = auth.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.first)()).subscribe();
      const redirectResult = auth.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)(auth => auth.getRedirectResult().then(it => it, () => null)), _angular_fire__WEBPACK_IMPORTED_MODULE_3__.keepUnstableUntilFirst, (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.shareReplay)({
        bufferSize: 1,
        refCount: false
      }));
      const authStateChanged = auth.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)(auth => new rxjs__WEBPACK_IMPORTED_MODULE_1__.Observable(sub => ({
        unsubscribe: zone.runOutsideAngular(() => auth.onAuthStateChanged(next => sub.next(next), err => sub.error(err), () => sub.complete()))
      }))));
      const idTokenChanged = auth.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)(auth => new rxjs__WEBPACK_IMPORTED_MODULE_1__.Observable(sub => ({
        unsubscribe: zone.runOutsideAngular(() => auth.onIdTokenChanged(next => sub.next(next), err => sub.error(err), () => sub.complete()))
      }))));
      this.authState = redirectResult.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMapTo)(authStateChanged), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.subscribeOn)(schedulers.outsideAngular), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.observeOn)(schedulers.insideAngular));
      this.user = redirectResult.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMapTo)(idTokenChanged), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.subscribeOn)(schedulers.outsideAngular), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.observeOn)(schedulers.insideAngular));
      this.idToken = this.user.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)(user => user ? (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.from)(user.getIdToken()) : (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)(null)));
      this.idTokenResult = this.user.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)(user => user ? (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.from)(user.getIdTokenResult()) : (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)(null)));
      this.credential = (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.merge)(redirectResult, logins,
      // pipe in null authState to make credential zipable, just a weird devexp if
      // authState and user go null to still have a credential
      this.authState.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.filter)(it => !it))).pipe(
      // handle the { user: { } } when a user is already logged in, rather have null
      // TODO handle the type corcersion better
      (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(credential => (credential === null || credential === void 0 ? void 0 : credential.user) ? credential : null), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.subscribeOn)(schedulers.outsideAngular), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.observeOn)(schedulers.insideAngular));
    }
    return (0,_angular_fire_compat__WEBPACK_IMPORTED_MODULE_4__["ɵlazySDKProxy"])(this, auth, zone, {
      spy: {
        apply: (name, _, val) => {
...
AngularFireAuth.ɵfac = function AngularFireAuth_Factory(t) {
  return new (t || AngularFireAuth)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_fire_compat__WEBPACK_IMPORTED_MODULE_4__.FIREBASE_OPTIONS), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_fire_compat__WEBPACK_IMPORTED_MODULE_4__.FIREBASE_APP_NAME, 8), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__.PLATFORM_ID), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__.NgZone), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_fire__WEBPACK_IMPORTED_MODULE_3__["ɵAngularFireSchedulers"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](USE_EMULATOR, 8), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](SETTINGS, 8), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](TENANT_ID, 8), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](LANGUAGE_CODE, 8), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](USE_DEVICE_LANGUAGE, 8), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](PERSISTENCE, 8), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_fire_app_check__WEBPACK_IMPORTED_MODULE_6__.AppCheckInstances, 8));
};
AngularFireAuth.ɵprov = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
  ...
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AngularFireAuth, [{
    ...
    return [{
      ...
      decorators: [{
        ...
        args: [_angular_fire_compat__WEBPACK_IMPORTED_MODULE_4__.FIREBASE_OPTIONS]
      }]
    }, {
      type: undefined,
      decorators: [{
        ...
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__.Inject,
        args: [_angular_fire_compat__WEBPACK_IMPORTED_MODULE_4__.FIREBASE_APP_NAME]
      }]
    }, {
      type: Object,
      decorators: [{
      ...
      type: _angular_fire__WEBPACK_IMPORTED_MODULE_3__["ɵAngularFireSchedulers"]
    }, {
      type: undefined,
      decorators: [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__.Optional
      ...
      type: _angular_fire_app_check__WEBPACK_IMPORTED_MODULE_6__.AppCheckInstances,
      decorators: [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__.Optional
      }]
    }];
...
(0,_angular_fire_compat__WEBPACK_IMPORTED_MODULE_4__["ɵapplyMixins"])(AngularFireAuth, [proxyPolyfillCompat]);
class AngularFireAuthModule {
  constructor() {
    firebase_compat_app__WEBPACK_IMPORTED_MODULE_7__["default"].registerVersion('angularfire', _angular_fire__WEBPACK_IMPORTED_MODULE_3__.VERSION.full, 'auth-compat');
  }
}
...
/* harmony export */ });
/* harmony import */ var _firebase_util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @firebase/util */ 91207);
...
/* harmony export */ });
/* harmony import */ var _firebase_app_compat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @firebase/app-compat */ 75602);
...
;
//# sourceMappingURL=node_modules_angular_fire_fesm2015_angular-fire-compat-auth_js-_94e01.js.map